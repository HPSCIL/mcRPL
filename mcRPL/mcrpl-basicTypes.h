#ifndef MCRPL_BASICTYPES_H
#define MCRPL_BASICTYPES_H
...
namespace mcRPL {
  ...
  ***********************************************/
  mcRPL::MeshDir oppositeDir(mcRPL::MeshDir dir);
  ...
  ***********************************************/
   ...
   ***********************************************/
  mcRPL::PrimeDir oppositePrmDir(mcRPL::PrimeDir dir);
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcRPL::BasicNeighborhoodType &val);
  istream& operator>>(istream &is, mcRPL::BasicNeighborhoodType &val);
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcRPL::IntVect &vInt);
  ...
  ostream& operator<<(ostream &os, const mcRPL::LongVect &vLong);
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcRPL::DblVect &vDbl);
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcRPL::CharVect &vChar);

  /***********************************************
  * Integer-Integer Pair                         *
  ***********************************************/
  typedef pair<int, int> IntPair;
  ostream& operator<<(ostream &os, const mcRPL::IntPair &pair);
  class CoordBR;
  class Transition;
  typedef mcRPL::EvaluateReturn (mcRPL::Transition::*pCuf)(const mcRPL::CoordBR&);                //2018/10/25
  /***********************************************
  * Integer-Integer Map                          *
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcRPL::IntMap &mInt);
    ...
    public:
      ...
      SpaceDims(long nRows, long nCols)
        :_nRows(nRows),
         _nCols(nCols),
         _size(nRows*nCols) {}
      SpaceDims(const mcRPL::SpaceDims &rhs)
        :_nRows(rhs._nRows),
         _nCols(rhs._nCols),
         _size(rhs._size) {}
      ~SpaceDims() {}

      mcRPL::SpaceDims& operator=(const mcRPL::SpaceDims &rhs) {
        if(this != &rhs) {
          _nRows = rhs._nRows;
          _nCols = rhs._nCols;
          _size = rhs._size;
      ...
      bool operator==(const mcRPL::SpaceDims &rhs) const {
  ...
  ***********************************************/
  class CellCoord {
    public:
      CellCoord()
        :_iRow(mcRPL::ERROR_COORD),
         _iCol(mcRPL::ERROR_COORD) {}
      CellCoord(long iRow, long iCol)
        :_iRow(iRow),
         _iCol(iCol) {}
      CellCoord(const mcRPL::CellCoord &rhs)
        :_iRow(rhs._iRow),
         _iCol(rhs._iCol) {}
      CellCoord(long idx, const mcRPL::SpaceDims &dims) {
        fromIdx(idx, dims);
      }
      ~CellCoord() {}

      mcRPL::CellCoord& operator=(const mcRPL::CellCoord &rhs) {
        if(this != &rhs) {
          _iRow = rhs._iRow;
          _iCol = rhs._iCol;
        }
      ...
      void operator()(const mcRPL::CellCoord &rhs) {
        _iRow = rhs._iRow;
        _iCol = rhs._iCol;
      }
      ...
      bool operator==(const mcRPL::CellCoord &rhs) const {
      ...
      mcRPL::CellCoord operator+(const mcRPL::CellCoord &rhs) const{
      ...
      bool valid() const {
        return(_iRow != mcRPL::ERROR_COORD &&
               _iCol != mcRPL::ERROR_COORD);
      }
      bool valid(const mcRPL::SpaceDims& dims) const {
    ...
    * Public method to determine the direction in
	  ...
	  ************************************************/
      mcRPL::MeshDir locatedTo(const mcRPL::CellCoord &rhs) const {
        mcRPL::MeshDir dir = mcRPL::NONE_DIR;
        if(_iRow < rhs._iRow) {
          if(_iCol < rhs._iCol) dir = mcRPL::NORTHWEST_DIR;
          else if(_iCol == rhs._iCol) dir = mcRPL::NORTH_DIR;
          else if(_iCol > rhs._iCol) dir = mcRPL::NORTHEAST_DIR;
        }
        else if(_iRow == rhs._iRow) {
          if(_iCol < rhs._iCol) dir = mcRPL::WEST_DIR;
          else if(_iCol == rhs._iCol) dir = mcRPL::NONE_DIR;
          else if(_iCol > rhs._iCol) dir = mcRPL::EAST_DIR;
        }
        else if(_iRow > rhs._iRow) {
          if(_iCol < rhs._iCol) dir = mcRPL::SOUTHWEST_DIR;
          else if(_iCol == rhs._iCol) dir = mcRPL::SOUTH_DIR;
          else if(_iCol > rhs._iCol) dir = mcRPL::SOUTHEAST_DIR;
        }
        return dir;
      }
      ...
      ************************************************/
      long toIdx(const mcRPL::SpaceDims& dims) const {
        long idx;
        if(!valid(dims)) {
          idx = mcRPL::ERROR_COORD;
        }
        else {
      ...
      void fromIdx(long idx, const mcRPL::SpaceDims& dims) {
  ...
  ***********************************************/
  class WeightedCellCoord: public mcRPL::CellCoord {
    public:
      WeightedCellCoord()
        :mcRPL::CellCoord(),
         _weight(1.0) {}
      WeightedCellCoord(long iRow, long iCol,
                        double weight = 1.0)
        :mcRPL::CellCoord(iRow, iCol),
         _weight(weight) {}
      WeightedCellCoord(long idx, const mcRPL::SpaceDims &dims,
                        double weight = 1.0)
        :mcRPL::CellCoord(idx, dims),
         _weight(weight) {}

      WeightedCellCoord(const mcRPL::WeightedCellCoord &rhs) {
        mcRPL::CellCoord::_iRow = rhs.CellCoord::_iRow;
        mcRPL::CellCoord::_iCol = rhs.CellCoord::_iCol;
        _weight = rhs._weight;
      }
      ~WeightedCellCoord() {}
     
      mcRPL::WeightedCellCoord& operator=(const mcRPL::WeightedCellCoord &rhs) {
        if(this != &rhs) {
          mcRPL::CellCoord::_iRow = rhs.CellCoord::_iRow;
          mcRPL::CellCoord::_iCol = rhs.CellCoord::_iCol;
          _weight = rhs._weight;
      ...
      void operator()(const mcRPL::WeightedCellCoord &rhs) {
        mcRPL::CellCoord::_iRow = rhs.CellCoord::_iRow;
        mcRPL::CellCoord::_iCol = rhs.CellCoord::_iCol;
        _weight = rhs._weight;
      }
      void operator()(long iRow, long iCol,
                      double weight = 1.0) {
        mcRPL::CellCoord::_iRow = iRow;
        mcRPL::CellCoord::_iCol = iCol;
        _weight = weight;
      }
      bool operator==(const mcRPL::WeightedCellCoord &rhs) const {
      ...
      void add2Buf(vector<char> &buf) {
        ...
        mcRPL::CellCoord::add2Buf(buf);
      }

      bool initFromBuf(vector<char> &buf) {
        if(!mcRPL::CellCoord::initFromBuf(buf)) {
          return false;
        }
  ...
  ***********************************************/
  class CoordBR {
    public:
      CoordBR() {}
      CoordBR(const mcRPL::CellCoord& nw,
              const mcRPL::CellCoord& se)
        :_nwCorner(nw),
         _seCorner(se) {}
      ...
      CoordBR& operator=(const mcRPL::CoordBR &rhs) {
        if(this != &rhs) {
          _nwCorner = rhs._nwCorner;
          _seCorner = rhs._seCorner;
        }
      ...
      bool operator==(const mcRPL::CoordBR &rhs) const {
      ...
      void nwCorner(const mcRPL::CellCoord &nw) {
        _nwCorner = nw;
      }
      void nwCorner(long iRow, long iCol) {
        _nwCorner(iRow, iCol);
      }
      void seCorner(const mcRPL::CellCoord &se) {
        _seCorner = se;
      }
      ...
      const mcRPL::CellCoord& nwCorner() const {
        return _nwCorner;  
      }
      const mcRPL::CellCoord& seCorner() const {
        return _seCorner;  
      }
      ...
      bool ifContain(const mcRPL::CellCoord &coord) const {
      ...
      bool ifContain(const mcRPL::CoordBR &rhs) const {
        return (rhs.valid() &&
                ifContain(rhs._nwCorner) &&
                ifContain(rhs._seCorner));
      }
      bool ifWithin(const mcRPL::CoordBR &rhs) const {
        return (rhs.ifContain(*this));
      }

      mcRPL::CoordBR overlap(const mcRPL::CoordBR &rhs) const {
        mcRPL::CoordBR olBR;
        if(valid() && rhs.valid()) {
      ...
      mcRPL::CoordBR merge(const mcRPL::CoordBR &rhs) const {
        mcRPL::CoordBR mgBR;
        if(valid() && rhs.valid()) {
    ...
    private:
      mcRPL::CellCoord _nwCorner;
      mcRPL::CellCoord _seCorner;
  };

  class GeoCoord {
    public:
    	GeoCoord()
        :_x(mcRPL::ERROR_COORD),
         _y(mcRPL::ERROR_COORD) {}
      GeoCoord(double x, double y)
        :_x(x),
         _y(y) {}
      GeoCoord(const mcRPL::GeoCoord &rhs)
        :_x(rhs._x),
         _y(rhs._y) {}
      ~GeoCoord() {}

      mcRPL::GeoCoord& operator=(const mcRPL::GeoCoord &rhs) {
        if(this != &rhs) {
          _x = rhs._x;
          _y = rhs._y;
        }
      ...
      void operator()(const mcRPL::GeoCoord &rhs) {
        _x = rhs._x;
        _y = rhs._y;
      }
      ...
      bool operator==(const mcRPL::GeoCoord &rhs) const {
      ...
      mcRPL::GeoCoord operator+(const mcRPL::GeoCoord &rhs) const{
  ...
  ***********************************************/
  ostream& operator<<(ostream &os, const mcRPL::SpaceDims &dims);
  istream& operator>>(istream &is, mcRPL::SpaceDims &dims);
  ostream& operator<<(ostream &os, const mcRPL::CellCoord &coord);
  istream& operator>>(istream &is, mcRPL::CellCoord &coord);
  ostream& operator<<(ostream &os, const mcRPL::WeightedCellCoord &coord);
  istream& operator>>(istream &is, mcRPL::WeightedCellCoord &coord);
  ostream& operator<<(ostream &os, const mcRPL::CoordBR &br);
  ostream& operator<<(ostream &os, const mcRPL::GeoCoord &gcoord);
  istream& operator>>(istream &is, mcRPL::GeoCoord &gcoord);
};
