#ifndef mcPRL_BASICTYPES_H
#define mcPRL_BASICTYPES_H
...
namespace mcPRL {
  ...
  ***********************************************/
  mcPRL::MeshDir oppositeDir(mcPRL::MeshDir dir);
  ...
  ***********************************************/
   ...
   ***********************************************/
  mcPRL::PrimeDir oppositePrmDir(mcPRL::PrimeDir dir);
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcPRL::BasicNeighborhoodType &val);
  istream& operator>>(istream &is, mcPRL::BasicNeighborhoodType &val);
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcPRL::IntVect &vInt);
  ...
  ostream& operator<<(ostream &os, const mcPRL::LongVect &vLong);
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcPRL::DblVect &vDbl);
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcPRL::CharVect &vChar);

  /***********************************************
  * Integer-Integer Pair                         *
  ***********************************************/
  typedef pair<int, int> IntPair;
  ostream& operator<<(ostream &os, const mcPRL::IntPair &pair);
  class CoordBR;
  class Transition;
  typedef mcPRL::EvaluateReturn (mcPRL::Transition::*pCuf)(const mcPRL::CoordBR&);                //2018/10/25
  /***********************************************
  * Integer-Integer Map                          *
  ...
  ***********************************************/
  ...
  ostream& operator<<(ostream &os, const mcPRL::IntMap &mInt);
    ...
    public:
      ...
      SpaceDims(long nRows, long nCols)
        :_nRows(nRows),
         _nCols(nCols),
         _size(nRows*nCols) {}
      SpaceDims(const mcPRL::SpaceDims &rhs)
        :_nRows(rhs._nRows),
         _nCols(rhs._nCols),
         _size(rhs._size) {}
      ~SpaceDims() {}

      mcPRL::SpaceDims& operator=(const mcPRL::SpaceDims &rhs) {
        if(this != &rhs) {
          _nRows = rhs._nRows;
          _nCols = rhs._nCols;
          _size = rhs._size;
      ...
      bool operator==(const mcPRL::SpaceDims &rhs) const {
  ...
  ***********************************************/
  class CellCoord {
    public:
      CellCoord()
        :_iRow(mcPRL::ERROR_COORD),
         _iCol(mcPRL::ERROR_COORD) {}
      CellCoord(long iRow, long iCol)
        :_iRow(iRow),
         _iCol(iCol) {}
      CellCoord(const mcPRL::CellCoord &rhs)
        :_iRow(rhs._iRow),
         _iCol(rhs._iCol) {}
      CellCoord(long idx, const mcPRL::SpaceDims &dims) {
        fromIdx(idx, dims);
      }
      ~CellCoord() {}

      mcPRL::CellCoord& operator=(const mcPRL::CellCoord &rhs) {
        if(this != &rhs) {
          _iRow = rhs._iRow;
          _iCol = rhs._iCol;
        }
      ...
      void operator()(const mcPRL::CellCoord &rhs) {
        _iRow = rhs._iRow;
        _iCol = rhs._iCol;
      }
      ...
      bool operator==(const mcPRL::CellCoord &rhs) const {
      ...
      mcPRL::CellCoord operator+(const mcPRL::CellCoord &rhs) const{
      ...
      bool valid() const {
        return(_iRow != mcPRL::ERROR_COORD &&
               _iCol != mcPRL::ERROR_COORD);
      }
      bool valid(const mcPRL::SpaceDims& dims) const {
    ...
    * Public method to determine the direction in
	  ...
	  ************************************************/
      mcPRL::MeshDir locatedTo(const mcPRL::CellCoord &rhs) const {
        mcPRL::MeshDir dir = mcPRL::NONE_DIR;
        if(_iRow < rhs._iRow) {
          if(_iCol < rhs._iCol) dir = mcPRL::NORTHWEST_DIR;
          else if(_iCol == rhs._iCol) dir = mcPRL::NORTH_DIR;
          else if(_iCol > rhs._iCol) dir = mcPRL::NORTHEAST_DIR;
        }
        else if(_iRow == rhs._iRow) {
          if(_iCol < rhs._iCol) dir = mcPRL::WEST_DIR;
          else if(_iCol == rhs._iCol) dir = mcPRL::NONE_DIR;
          else if(_iCol > rhs._iCol) dir = mcPRL::EAST_DIR;
        }
        else if(_iRow > rhs._iRow) {
          if(_iCol < rhs._iCol) dir = mcPRL::SOUTHWEST_DIR;
          else if(_iCol == rhs._iCol) dir = mcPRL::SOUTH_DIR;
          else if(_iCol > rhs._iCol) dir = mcPRL::SOUTHEAST_DIR;
        }
        return dir;
      }
      ...
      ************************************************/
      long toIdx(const mcPRL::SpaceDims& dims) const {
        long idx;
        if(!valid(dims)) {
          idx = mcPRL::ERROR_COORD;
        }
        else {
      ...
      void fromIdx(long idx, const mcPRL::SpaceDims& dims) {
  ...
  ***********************************************/
  class WeightedCellCoord: public mcPRL::CellCoord {
    public:
      WeightedCellCoord()
        :mcPRL::CellCoord(),
         _weight(1.0) {}
      WeightedCellCoord(long iRow, long iCol,
                        double weight = 1.0)
        :mcPRL::CellCoord(iRow, iCol),
         _weight(weight) {}
      WeightedCellCoord(long idx, const mcPRL::SpaceDims &dims,
                        double weight = 1.0)
        :mcPRL::CellCoord(idx, dims),
         _weight(weight) {}

      WeightedCellCoord(const mcPRL::WeightedCellCoord &rhs) {
        mcPRL::CellCoord::_iRow = rhs.CellCoord::_iRow;
        mcPRL::CellCoord::_iCol = rhs.CellCoord::_iCol;
        _weight = rhs._weight;
      }
      ~WeightedCellCoord() {}
     
      mcPRL::WeightedCellCoord& operator=(const mcPRL::WeightedCellCoord &rhs) {
        if(this != &rhs) {
          mcPRL::CellCoord::_iRow = rhs.CellCoord::_iRow;
          mcPRL::CellCoord::_iCol = rhs.CellCoord::_iCol;
          _weight = rhs._weight;
      ...
      void operator()(const mcPRL::WeightedCellCoord &rhs) {
        mcPRL::CellCoord::_iRow = rhs.CellCoord::_iRow;
        mcPRL::CellCoord::_iCol = rhs.CellCoord::_iCol;
        _weight = rhs._weight;
      }
      void operator()(long iRow, long iCol,
                      double weight = 1.0) {
        mcPRL::CellCoord::_iRow = iRow;
        mcPRL::CellCoord::_iCol = iCol;
        _weight = weight;
      }
      bool operator==(const mcPRL::WeightedCellCoord &rhs) const {
      ...
      void add2Buf(vector<char> &buf) {
        ...
        mcPRL::CellCoord::add2Buf(buf);
      }

      bool initFromBuf(vector<char> &buf) {
        if(!mcPRL::CellCoord::initFromBuf(buf)) {
          return false;
        }
  ...
  ***********************************************/
  class CoordBR {
    public:
      CoordBR() {}
      CoordBR(const mcPRL::CellCoord& nw,
              const mcPRL::CellCoord& se)
        :_nwCorner(nw),
         _seCorner(se) {}
      ...
      CoordBR& operator=(const mcPRL::CoordBR &rhs) {
        if(this != &rhs) {
          _nwCorner = rhs._nwCorner;
          _seCorner = rhs._seCorner;
        }
      ...
      bool operator==(const mcPRL::CoordBR &rhs) const {
      ...
      void nwCorner(const mcPRL::CellCoord &nw) {
        _nwCorner = nw;
      }
      void nwCorner(long iRow, long iCol) {
        _nwCorner(iRow, iCol);
      }
      void seCorner(const mcPRL::CellCoord &se) {
        _seCorner = se;
      }
      ...
      const mcPRL::CellCoord& nwCorner() const {
        return _nwCorner;  
      }
      const mcPRL::CellCoord& seCorner() const {
        return _seCorner;  
      }
      ...
      bool ifContain(const mcPRL::CellCoord &coord) const {
      ...
      bool ifContain(const mcPRL::CoordBR &rhs) const {
        return (rhs.valid() &&
                ifContain(rhs._nwCorner) &&
                ifContain(rhs._seCorner));
      }
      bool ifWithin(const mcPRL::CoordBR &rhs) const {
        return (rhs.ifContain(*this));
      }

      mcPRL::CoordBR overlap(const mcPRL::CoordBR &rhs) const {
        mcPRL::CoordBR olBR;
        if(valid() && rhs.valid()) {
      ...
      mcPRL::CoordBR merge(const mcPRL::CoordBR &rhs) const {
        mcPRL::CoordBR mgBR;
        if(valid() && rhs.valid()) {
    ...
    private:
      mcPRL::CellCoord _nwCorner;
      mcPRL::CellCoord _seCorner;
  };

  class GeoCoord {
    public:
    	GeoCoord()
        :_x(mcPRL::ERROR_COORD),
         _y(mcPRL::ERROR_COORD) {}
      GeoCoord(double x, double y)
        :_x(x),
         _y(y) {}
      GeoCoord(const mcPRL::GeoCoord &rhs)
        :_x(rhs._x),
         _y(rhs._y) {}
      ~GeoCoord() {}

      mcPRL::GeoCoord& operator=(const mcPRL::GeoCoord &rhs) {
        if(this != &rhs) {
          _x = rhs._x;
          _y = rhs._y;
        }
      ...
      void operator()(const mcPRL::GeoCoord &rhs) {
        _x = rhs._x;
        _y = rhs._y;
      }
      ...
      bool operator==(const mcPRL::GeoCoord &rhs) const {
      ...
      mcPRL::GeoCoord operator+(const mcPRL::GeoCoord &rhs) const{
  ...
  ***********************************************/
  ostream& operator<<(ostream &os, const mcPRL::SpaceDims &dims);
  istream& operator>>(istream &is, mcPRL::SpaceDims &dims);
  ostream& operator<<(ostream &os, const mcPRL::CellCoord &coord);
  istream& operator>>(istream &is, mcPRL::CellCoord &coord);
  ostream& operator<<(ostream &os, const mcPRL::WeightedCellCoord &coord);
  istream& operator>>(istream &is, mcPRL::WeightedCellCoord &coord);
  ostream& operator<<(ostream &os, const mcPRL::CoordBR &br);
  ostream& operator<<(ostream &os, const mcPRL::GeoCoord &gcoord);
  istream& operator>>(istream &is, mcPRL::GeoCoord &gcoord);
};
