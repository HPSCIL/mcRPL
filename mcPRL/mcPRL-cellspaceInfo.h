#ifndef mcPRL_CELLSPACEINFO_H
#define mcPRL_CELLSPACEINFO_H
...
namespace mcPRL {
  class CellspaceInfo {
    public:
      ...
      mcPRL::CellspaceInfo& operator=(const mcPRL::CellspaceInfo &rhs);
      bool operator==(const mcPRL::CellspaceInfo &rhs);
      bool operator!=(const mcPRL::CellspaceInfo &rhs);

      bool init(const mcPRL::SpaceDims &dims,
                const char *aTypeName,
                size_t typeSize,
                const mcPRL::CellspaceGeoinfo *pGeoinfo = NULL,
                long tileSize = TILEWIDTH);
     ...
     bool initByPGTIOL(PGTIOLDataset *pDataset,
      ...
      void dims(const mcPRL::SpaceDims& cellDims);
      ...
      void georeference(const mcPRL::CellspaceGeoinfo &geoinfo);
      const mcPRL::CellspaceGeoinfo* georeference() const;
      ...
      mcPRL::CellCoord idx2coord(long idx) const;
      ...
      bool validIdx(long idx,
                    bool warning = true) const;
      bool validBR(const mcPRL::CoordBR &rectangle,
                   bool warning = true) const;
      ...
      bool calcWorkBR(mcPRL::CoordBR *pWorkBR,
                      const mcPRL::Neighborhood *pNbrhd,
                      bool warning = true) const;

      bool validNbrhd(const mcPRL::Neighborhood &nbrhd,
    ...
    private:
      ...
      size_t _dTypeSize;
      void *_pNoDataVal;
      mcPRL::CellspaceGeoinfo *_pGeoInfo;
      long _tileSize;
  };
};
...
template<class RtrType>
const RtrType mcPRL::CellspaceInfo::
